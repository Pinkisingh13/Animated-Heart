      ...
      body: Padding(
        ...
        child: Stack(
          children: [
            ...
            Positioned.fill(
              child: IgnorePointer(
                child: CustomPaint(painter: HeartParticlesPainter(particles)),
              ),
            ),
          ],
        ),
...
class MyPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // LEFT CURVE
    path.cubicTo(
      size.width * 0.01, // 0.01, 0.50 = Pull left side OUTWARD (left bulge)
      size.height * 0.50,
      size.width * 0.40, // 0.40, 0.30 = Create ROUNDNESS of left bump at top
      size.height * 0.3,
